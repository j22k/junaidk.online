    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr] gap-16">
        <div>
          ...
          <div className="text-[16px] font-dm font-light leading-[1.8] text-[rgba(29,29,31,0.55)] space-y-6">
            <p>{PROFILE.bio}</p>
          </div>
        </div>
        ...
        <div className="flex flex-col">
          {STATS.map((stat, i) => (
            <div key={i} className="py-6 border-b border-[rgba(29,29,31,0.08)] first:border-t flex flex-col gap-1">
              <div className="font-cormorant font-semibold text-5xl">
                <AnimatedNumber value={stat.value} />{stat.suffix}
              </div>
              <div className="font-dm font-light text-sm text-[rgba(29,29,31,0.5)]">
                {stat.label}
              </div>
            </div>
          ))}
