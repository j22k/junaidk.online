      ...
      <div className="flex flex-col border-t border-[rgba(29,29,31,0.08)]">
        {PROJECTS.map((project, i) => {
          ...
          return (
            <div
              key={project.id}
              className="group relative flex flex-col md:flex-row gap-6 md:gap-12 py-8 border-b border-[rgba(29,29,31,0.08)] px-4 -mx-4 hover:bg-[rgba(29,29,31,0.03)] transition-colors duration-200"
            >
              <div className="absolute top-4 left-4 text-[rgba(29,29,31,0.1)] font-cormorant font-light text-6xl pointer-events-none transition-opacity duration-300 group-hover:opacity-0">
                {num}
              </div>
              ...
              <div className="flex-1 md:ml-[80px] z-10">
                ...
                <p className="font-dm font-light text-[14px] text-[rgba(29,29,31,0.5)] leading-[1.6] mb-4">
                  {project.description}
                </p>
