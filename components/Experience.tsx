      ...
      <div className="flex flex-col border-t border-[rgba(29,29,31,0.08)]">
        {EXPERIENCES.map((exp, i) => {
          ...
          return (
            <div
              key={exp.id}
              className="group flex flex-col sm:flex-row sm:items-baseline justify-between py-6 border-b border-[rgba(29,29,31,0.08)] transition-colors duration-200 hover:bg-[rgba(29,29,31,0.03)] px-4 -mx-4"
            >
              <div className="flex flex-col mb-2 sm:mb-0">
                ...
                <span className="font-dm font-light text-[14px] text-[rgba(29,29,31,0.5)]">
                  {exp.company}
                </span>
                ...
                <div className="flex gap-2 mt-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  {exp.tech.slice(0, 3).map(tech => (
                    <span key={tech} className="font-dm font-light text-[10px] text-[rgba(29,29,31,0.4)] border border-[rgba(29,29,31,0.08)] px-2 py-0.5 rounded-full">
                      {tech}
                    </span>
                  ))}
                </div>
              ...
              <div className="font-dm font-light text-[12px] text-[rgba(29,29,31,0.4)] sm:text-right">
